...
var _user$project$Fortune$serverURL = 'http://127.0.0.1:1234/';
var _user$project$Fortune$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$none;
};
var _user$project$Fortune$Model = function (a) {
	return {fortune: a};
};
var _user$project$Fortune$NewFortune = {ctor: 'NewFortune'};
var _user$project$Fortune$view = function (model) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(model.fortune)
					])),
				A2(
				_elm_lang$html$Html$button,
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Events$onClick(_user$project$Fortune$NewFortune)
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('New Fortune')
					]))
			]));
};
var _user$project$Fortune$FetchFail = function (a) {
	return {ctor: 'FetchFail', _0: a};
};
var _user$project$Fortune$FetchSuccess = function (a) {
	return {ctor: 'FetchSuccess', _0: a};
};
var _user$project$Fortune$getRandomFortune = function () {
	var url = A2(_elm_lang$core$Basics_ops['++'], _user$project$Fortune$serverURL, '/fortune');
	return A3(
		_elm_lang$core$Task$perform,
		_user$project$Fortune$FetchFail,
		_user$project$Fortune$FetchSuccess,
		A2(_evancz$elm_http$Http$get, _elm_lang$core$Json_Decode$string, url));
}();
var _user$project$Fortune$init = function (s) {
	return {
		ctor: '_Tuple2',
		_0: _user$project$Fortune$Model(s),
		_1: _user$project$Fortune$getRandomFortune
	};
};
var _user$project$Fortune$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'FetchSuccess':
				return {
					ctor: '_Tuple2',
					_0: _user$project$Fortune$Model(_p0._0),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'FetchFail':
				return {
					ctor: '_Tuple2',
					_0: _user$project$Fortune$Model('Sorry, I failed in reading your fortune! Try again?'),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			default:
				return {ctor: '_Tuple2', _0: model, _1: _user$project$Fortune$getRandomFortune};
		}
	});
var _user$project$Fortune$main = {
	main: _elm_lang$html$Html_App$program(
		{
			init: _user$project$Fortune$init('Reading your fortune...'),
			view: _user$project$Fortune$view,
			update: _user$project$Fortune$update,
			subscriptions: _user$project$Fortune$subscriptions
		})
};

var Elm = {};
Elm['Fortune'] = Elm['Fortune'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Fortune'], 'Fortune', typeof _user$project$Fortune$main === 'undefined' ? null : _user$project$Fortune$main);
